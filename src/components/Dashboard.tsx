...
import { Sun, Sprout, DollarSign, Droplets, AlertTriangle } from 'lucide-react';
...
const Dashboard: React.FC<DashboardProps> = ({ farmer = {} }) => {
  // Weather Data
  const weatherData = { temperature: 28, humidity: 72, rainfall: 45, condition: 'Partly Cloudy' };
  ...
  return (
    <div className="space-y-6 min-h-screen p-4">
      ...
      <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 text-white">
        <h1 className="text-2xl font-bold mb-2">Welcome back, {farmer.name || 'Farmer'}! 🌾</h1>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <h3 className="text-lg font-semibold mb-4 flex items-center">
          <Sun className="mr-2 text-yellow-500" size={20} />Today's Weather
        </h3>
